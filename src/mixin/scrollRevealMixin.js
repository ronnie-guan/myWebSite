...
export default {
    ...
    mounted() {
        ...
        this.scrollReveal.reveal('.arraystar', { ...config, origin: 'bottom' });
        this.scrollReveal.reveal('.company_production_line', { ...config, origin: 'bottom' });
        this.scrollReveal.reveal('.certification_system', { ...config, origin: 'bottom' });
